...
* [hoppscotch](https://github.com/hoppscotch/hoppscotch) ⭐ 80,103 | 🐛 804 | 🌐 TypeScript | 📅 2026-08-27 : :alien: A free, fast and beautiful API request builder used by 80k+ developers.
* [Resume Matcher](https://github.com/srbhr/Resume-Matcher) ⭐ 28,256 | 🐛 67 | 🌐 TypeScript | 📅 2026-08-11 : The Resume Matcher takes your resume and job descriptions as input, parses them using Python, and mimics the functionalities of an ATS, providing you with insights and suggestions to make your resume ATS-friendly.
* [Forem](https://github.com/forem/forem) ⭐ 22,770 | 🐛 130 | 🌐 Ruby | 📅 2026-08-27 : :seedling: Forem is open source software for building communities. Communities for your peers, customers, fanbases, families, friends, and any other time and space where people need to come together to be part of a collective.
...
* [Directory of Online CS Courses](https://github.com/ossu/computer-science) ⭐ 208,454 | 🐛 26 | 🌐 HTML | 📅 2026-07-14 : Free online CS courses
* [Airbnb JS Style Guide](https://github.com/airbnb/javascript) ⭐ 148,140 | 🐛 163 | 🌐 JavaScript | 📅 2026-04-16 : A mostly reasonable approach to JavaScript
...
* [Public API's](https://github.com/public-apis/public-apis#development) ⭐ 471,482 | 🐛 1,788 | 🌐 Python | 📅 2026-08-26 : Github Link for all the popular public API's.
