...
* [hoppscotch](https://github.com/hoppscotch/hoppscotch) ⭐ 80,112 | 🐛 804 | 🌐 TypeScript | 📅 2026-08-28 : :alien: A free, fast and beautiful API request builder used by 80k+ developers.
* [Resume Matcher](https://github.com/srbhr/Resume-Matcher) ⭐ 28,269 | 🐛 68 | 🌐 TypeScript | 📅 2026-08-11 : The Resume Matcher takes your resume and job descriptions as input, parses them using Python, and mimics the functionalities of an ATS, providing you with insights and suggestions to make your resume ATS-friendly.
...
* [Directory of Online CS Courses](https://github.com/ossu/computer-science) ⭐ 208,498 | 🐛 27 | 🌐 HTML | 📅 2026-07-14 : Free online CS courses
...
* [Directory of CS Courses (many with online lectures)](https://github.com/prakhar1989/awesome-courses) ⭐ 70,735 | 🐛 65 | 📅 2023-05-04 : Another online CS courses
...
* [Public API's](https://github.com/public-apis/public-apis#development) ⭐ 472,560 | 🐛 1,820 | 🌐 Python | 📅 2026-08-26 : Github Link for all the popular public API's.
