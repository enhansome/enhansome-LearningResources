...
* [hoppscotch](https://github.com/hoppscotch/hoppscotch) ⭐ 80,507 | 🐛 831 | 🌐 TypeScript | 📅 2026-09-25 : :alien: A free, fast and beautiful API request builder used by 80k+ developers.
* [Resume Matcher](https://github.com/srbhr/Resume-Matcher) ⭐ 28,516 | 🐛 58 | 🌐 Python | 📅 2026-09-24 : The Resume Matcher takes your resume and job descriptions as input, parses them using Python, and mimics the functionalities of an ATS, providing you with insights and suggestions to make your resume ATS-friendly.
* [Forem](https://github.com/forem/forem) ⭐ 22,782 | 🐛 144 | 🌐 Ruby | 📅 2026-09-24 : :seedling: Forem is open source software for building communities. Communities for your peers, customers, fanbases, families, friends, and any other time and space where people need to come together to be part of a collective.
...
* [Directory of Online CS Courses](https://github.com/ossu/computer-science) ⭐ 209,441 | 🐛 28 | 🌐 HTML | 📅 2026-07-14 : Free online CS courses
* [Airbnb JS Style Guide](https://github.com/airbnb/javascript) ⭐ 148,272 | 🐛 165 | 🌐 JavaScript | 📅 2026-04-16 : A mostly reasonable approach to JavaScript
* [Directory of CS Courses (many with online lectures)](https://github.com/prakhar1989/awesome-courses) ⭐ 71,387 | 🐛 65 | 📅 2023-05-04 : Another online CS courses
* [Angular 1 Style Guide](https://github.com/johnpapa/angular-styleguide/tree/master/a1) ⭐ 23,608 | 🐛 1 | 🌐 Vim Snippet | 📅 2026-04-30 : Officially endorsed style guide by John Pappa
...
* [The Concise TypeScript Book](https://github.com/gibbok/typescript-book) ⭐ 10,355 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-25 : Free, open-source TypeScript reference by Simone Poggiali.
...
* [Public API's](https://github.com/public-apis/public-apis#development) ⭐ 483,015 | 🐛 1,947 | 🌐 Python | 📅 2026-09-24 : Github Link for all the popular public API's.
