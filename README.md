...
* [hoppscotch](https://github.com/hoppscotch/hoppscotch) ⭐ 80,093 | 🐛 802 | 🌐 TypeScript | 📅 2026-08-24 : :alien: A free, fast and beautiful API request builder used by 80k+ developers.
* [Resume Matcher](https://github.com/srbhr/Resume-Matcher) ⭐ 28,243 | 🐛 68 | 🌐 TypeScript | 📅 2026-08-11 : The Resume Matcher takes your resume and job descriptions as input, parses them using Python, and mimics the functionalities of an ATS, providing you with insights and suggestions to make your resume ATS-friendly.
...
* [Public API's](https://github.com/public-apis/public-apis#development) ⭐ 470,025 | 🐛 1,772 | 🌐 Python | 📅 2026-08-19 : Github Link for all the popular public API's.
