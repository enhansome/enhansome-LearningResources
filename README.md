# Awesome LearningResources with stars
...
* [hoppscotch](https://github.com/hoppscotch/hoppscotch) ⭐ 80,403 | 🐛 826 | 🌐 TypeScript | 📅 2026-09-16 : :alien: A free, fast and beautiful API request builder used by 80k+ developers.
* [Resume Matcher](https://github.com/srbhr/Resume-Matcher) ⭐ 28,474 | 🐛 56 | 🌐 Python | 📅 2026-09-10 : The Resume Matcher takes your resume and job descriptions as input, parses them using Python, and mimics the functionalities of an ATS, providing you with insights and suggestions to make your resume ATS-friendly.
* [Forem](https://github.com/forem/forem) ⭐ 22,779 | 🐛 139 | 🌐 Ruby | 📅 2026-09-19 : :seedling: Forem is open source software for building communities. Communities for your peers, customers, fanbases, families, friends, and any other time and space where people need to come together to be part of a collective.
* [Dynamic-Github-README-Quotes](https://github.com/shravan20/github-readme-quotes) ⭐ 308 | 🐛 50 | 🌐 JavaScript | 📅 2025-09-29 : Dynamic quote generator for your GitHub Profile READMEs
...
* [custom-input-types](https://github.com/atish31/custom-input-types) ⭐ 3 | 🐛 0 | 🌐 JavaScript | 📅 2021-04-05 : Custom Input Types lets you use customised input types without writing any JavaScript for yourself
...
| :---: | :----------------------------------: | :------------------------: | :------------------------: | :--------------------------------------------------: |
|   1   |     [Node.js](tech-stack/nodejs)     |                            |                            | :ballot\_box\_with\_check: (Server-Side Environment) |
|   2   |    [React.js](tech-stack/reactjs)    |                            | :ballot\_box\_with\_check: |                                                      |
|   3   | [Spring Boot](tech-stack/springboot) | :ballot\_box\_with\_check: |                            |                                                      |

### Programming Style Guides :memo:

* [Directory of Online CS Courses](https://github.com/ossu/computer-science) ⭐ 209,198 | 🐛 28 | 🌐 HTML | 📅 2026-07-14 : Free online CS courses
* [Airbnb JS Style Guide](https://github.com/airbnb/javascript) ⭐ 148,249 | 🐛 165 | 🌐 JavaScript | 📅 2026-04-16 : A mostly reasonable approach to JavaScript
* [Directory of CS Courses (many with online lectures)](https://github.com/prakhar1989/awesome-courses) ⭐ 71,271 | 🐛 64 | 📅 2023-05-04 : Another online CS courses
* [Angular 1 Style Guide](https://github.com/johnpapa/angular-styleguide/tree/master/a1) ⭐ 23,611 | 🐛 1 | 🌐 Vim Snippet | 📅 2026-04-30 : Officially endorsed style guide by John Pappa
...
### Must-Read Books to be developers or problem solver :closed\_book: :notebook\_with\_decorative\_cover:

* [The Concise TypeScript Book](https://github.com/gibbok/typescript-book) ⭐ 10,349 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-18 : Free, open-source TypeScript reference by Simone Poggiali.
...
* [Public API's](https://github.com/public-apis/public-apis#development) ⭐ 481,723 | 🐛 1,948 | 🌐 Python | 📅 2026-09-18 : Github Link for all the popular public API's.
