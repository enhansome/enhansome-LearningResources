...
* [hoppscotch](https://github.com/hoppscotch/hoppscotch) ⭐ 80,067 | 🐛 797 | 🌐 TypeScript | 📅 2026-08-20 : :alien: A free, fast and beautiful API request builder used by 80k+ developers.
* [Resume Matcher](https://github.com/srbhr/Resume-Matcher) ⭐ 28,195 | 🐛 67 | 🌐 TypeScript | 📅 2026-08-11 : The Resume Matcher takes your resume and job descriptions as input, parses them using Python, and mimics the functionalities of an ATS, providing you with insights and suggestions to make your resume ATS-friendly.
* [Forem](https://github.com/forem/forem) ⭐ 22,768 | 🐛 131 | 🌐 Ruby | 📅 2026-08-20 : :seedling: Forem is open source software for building communities. Communities for your peers, customers, fanbases, families, friends, and any other time and space where people need to come together to be part of a collective.
...
* [Directory of Online CS Courses](https://github.com/ossu/computer-science) ⭐ 208,262 | 🐛 25 | 🌐 HTML | 📅 2026-07-14 : Free online CS courses
...
* [Directory of CS Courses (many with online lectures)](https://github.com/prakhar1989/awesome-courses) ⭐ 70,556 | 🐛 64 | 📅 2023-05-04 : Another online CS courses
* [Angular 1 Style Guide](https://github.com/johnpapa/angular-styleguide/tree/master/a1) ⭐ 23,619 | 🐛 1 | 🌐 Vim Snippet | 📅 2026-04-30 : Officially endorsed style guide by John Pappa
...
* [Public API's](https://github.com/public-apis/public-apis#development) ⭐ 467,345 | 🐛 1,716 | 🌐 Python | 📅 2026-08-19 : Github Link for all the popular public API's.
